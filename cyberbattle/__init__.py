...
from ._env.cyberphysicalbattle_env import AttackerGoal as CPSAttackerGoal
from ._env.cyberphysicalbattle_env import DefenderGoal as CPSDefenderGoal
...
if 'CyberPhysicalBattle-v0' in registry.env_specs:
    del registry.env_specs['CyberPhysicalBattle-v0']

register(
    id='CyberPhysicalBattle-v0',
    cyberbattle_env_identifiers=control_center.ENV_IDENTIFIERS,
    entry_point='cyberbattle._env.cyberphysicalbattle_control_center:CyberPhysicalBattleControlCenter',
    kwargs={
            'defender_agent': None,
            'attacker_goal': CPSAttackerGoal(own_atleast_percent=1.0),
            'defender_goal': CPSDefenderGoal(eviction=True),
            'winning_reward': 5000.0,
            'losing_reward': 0.0
            },
    reward_threshold=2200,
